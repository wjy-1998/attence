...
<?php
	...
	$date = $_POST["date"];
	$jieci = $_POST["kkjieci"];
	$kaoqin = $_POST["kkkaoqin"];
	$pingfen = $_POST["kkpingfen"];
	$day=$_POST["day"];
	$week=$_POST["weekend"];
	$link = mysqli_connect("localhost","root","123456","students");
	mysqli_set_charset($link,"utf8");
	$sql1 = "INSERT INTO `kaoqin`(`stu_id`,`class_name`,`zhuanye_name`,`date`,`day`,`jieci`,`kaoqin`,`pingfen`,`week`) VALUES('$xuehao','$class','$zhuanye','$date','$day','$jieci','$kaoqin','$pingfen','$week');";
							...
							<ul>
								<?php
									...
									while($row=mysqli_fetch_array($result)){
										...
										$stu_id = $row["stu_id"];
										$kaoqin = $row["kaoqin"];
										$sql1 = "select * from students,class where students.class_id=class.Id and xuehao = '$stu_id' and class_name = '$class';";
										$result1 = 	mysqli_query($link,$sql1);
										$row1 = mysqli_fetch_array($result1);
										$class1=$row1["class_name"];
										if($date==$date1 and $jieci==$jieci1 and $class==$class1){
												$name = $row1["name"];
